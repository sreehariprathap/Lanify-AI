...
import ReportImage from "./assets/1x1.jpg";
    ...
    <div className="p-5 flex flex-wrap justify-start gap-5">
      ...
      <Link to="/driving-report-dashboard">
        <div className="group group-hover:card group-hover:image-full relative w-96 shadow-sm rounded-lg">
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-base-50 bg-opacity-70 transition-opacity duration-300 ease-in-out ">
            <div className="text-center flex flex-col items-center">
              <h2 className="card-title text-black font-bold text-center text-4xl ">Get Report</h2>
              <p className=" opacity-0 group-hover:opacity-100 text-black shadow-sm">
                Get Driving Analysis Report
              </p>
            </div>
          </div>
        </div>
